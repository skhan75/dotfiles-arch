...
return require("packer").startup(function(use)
    ...
    use "plasticboy/vim-markdown"  -- Markdown syntax and folding
    use "lukas-reineke/headlines.nvim"  -- Better Markdown headlines
    use "preservim/vim-pencil"  -- Auto-wrapping for Markdown
